 ...
 *   - Step 2. Call #hal_ccni_query_event_status() to query the sent event status, please only send when the event status is idle.\n
 *
 *   - Step 3. Call #hal_ccni_set_event() to trigger an event.\n
 *
 * - Sample code:
 *    @code
...
/**
 * @brief This function trigger an intterupt of the destination core.
