...
/***************************G113i 增加****************************************/
/* for set led test task */
#define LED_TASK_NAME                 "ledtest"
#define LED_TASK_STACKSIZE            (1024)
#define LED_TASK_PRIO                 TASK_PRIORITY_TIMER//TASK_PRIORITY_NORMAL


/***************************modbus 增加****************************************/
/* for set led test task */
#define MODBUS_TASK_NAME                 "modus"
#define MODBUS_TASK_STACKSIZE            (10240)
#define MODBUS_TASK_PRIO                 TASK_PRIORITY_TIMER//TASK_PRIORITY_NORMAL
