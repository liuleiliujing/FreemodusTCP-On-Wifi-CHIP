...
void rc_g113i_gpio_init(void)
{
    ...
    ret = hal_gpio_init(HAL_GPIO_1);/*wangzaizhong   GPIO初始化*/
    ...
    /* Set pin as GPIO mode.*//*wangzaizhong */
    ...
    /* Set GPIO as output.*//*wangzaizhong */
    ret = hal_gpio_set_direction(HAL_GPIO_1, HAL_GPIO_DIRECTION_OUTPUT);
    if (HAL_GPIO_STATUS_OK != ret) {
    ...
    /* Read the output data of the pin for further validation.*//*wangzaizhong */
    ...
    if (HAL_GPIO_STATUS_OK != ret) {
        /*printf("GPIO init failed\r\n");*/
        hal_gpio_deinit(HAL_GPIO_12);
        return;
    }

    /* Set pin as GPIO mode.*/
    ret_pinmux_status = hal_pinmux_set_function(HAL_GPIO_12, HAL_GPIO_12_GPIO12);
    if (HAL_PINMUX_STATUS_OK != ret_pinmux_status) {
       /* printf("hal_pinmux_set_function  failed\r\n");*/
        hal_gpio_deinit(HAL_GPIO_12);
        return;
...
#if 0
/*******************GPIO11	WLAN LED	WIFI联网状态灯 红灯　************************/
    ret = hal_gpio_init(HAL_GPIO_11);
    if (HAL_GPIO_STATUS_OK != ret) {
        /*printf("GPIO init failed\r\n");*/
    ...
    /* Set pin as GPIO mode.*/
    ret_pinmux_status = hal_pinmux_set_function(HAL_GPIO_11, HAL_GPIO_11_GPIO11);
    if (HAL_PINMUX_STATUS_OK != ret_pinmux_status) {
       /* printf("hal_pinmux_set_function  failed\r\n");*/
        hal_gpio_deinit(HAL_GPIO_11);
        return;
    ...
    /* Set GPIO as output.*/
    ret = hal_gpio_set_direction(HAL_GPIO_11, HAL_GPIO_DIRECTION_OUTPUT);
    if (HAL_GPIO_STATUS_OK != ret) {
        /*printf("hal_gpio_set_direction failed\r\n");*/
        hal_gpio_deinit(HAL_GPIO_11);
        return;
...
/*******************GPIO12	WLAN LED	WIFI联网状态灯 绿灯　************************/
    ...
    /* Set GPIO as output.*/
    ret = hal_gpio_set_direction(HAL_GPIO_12, HAL_GPIO_DIRECTION_OUTPUT);
    if (HAL_GPIO_STATUS_OK != ret) {
        /*printf("hal_gpio_set_direction failed\r\n");*/
        hal_gpio_deinit(HAL_GPIO_12);
        return;
...
/*******************GPIO13	Status LED	Status状态灯 绿灯***********************/
    ...
    /* Set pin as GPIO mode.*/
    ret_pinmux_status = hal_pinmux_set_function(HAL_GPIO_13, HAL_GPIO_13_GPIO13);
    if (HAL_PINMUX_STATUS_OK != ret_pinmux_status) {
       /* printf("hal_pinmux_set_function  failed\r\n");*/
        hal_gpio_deinit(HAL_GPIO_13);
        return;
...
/*******************GPIO14	Flash_SIO1	SPI Flash x2接口***********************/
    ret = hal_gpio_init(HAL_GPIO_14);
    if (HAL_GPIO_STATUS_OK != ret) {
        /*printf("GPIO init failed\r\n");*/
        hal_gpio_deinit(HAL_GPIO_14);
        return;
    }

    /* Set pin as GPIO mode.*/
    ret_pinmux_status = hal_pinmux_set_function(HAL_GPIO_14, HAL_GPIO_14_GPIO14);
    if (HAL_PINMUX_STATUS_OK != ret_pinmux_status) {
       /* printf("hal_pinmux_set_function  failed\r\n");*/
        hal_gpio_deinit(HAL_GPIO_14);
        return;
    ...
    /* Read the output data of the pin for further validation.*//*wangzaizhong */
    data_pull_up =HAL_GPIO_DATA_HIGH;
    ret = hal_gpio_set_output(HAL_GPIO_14, data_pull_up);
    if (HAL_GPIO_STATUS_OK != ret) {
        /*printf("hal_gpio_set_input failed\r\n");*/
        hal_gpio_deinit(HAL_GPIO_14);
        return;
...
/*******************GPIO15	Flash_SIO0	SPI Flash x2接口***********************/
    ret = hal_gpio_init(HAL_GPIO_15);
    if (HAL_GPIO_STATUS_OK != ret) {
        /*printf("GPIO init failed\r\n");*/
        hal_gpio_deinit(HAL_GPIO_15);
        return;
    }

    /* Set pin as GPIO mode.*/
    ret_pinmux_status = hal_pinmux_set_function(HAL_GPIO_15, HAL_GPIO_15_GPIO15);
    if (HAL_PINMUX_STATUS_OK != ret_pinmux_status) {
       /* printf("hal_pinmux_set_function  failed\r\n");*/
        hal_gpio_deinit(HAL_GPIO_15);
        return;
    ...
    /* Set GPIO as input.*/
    ret = hal_gpio_set_direction(HAL_GPIO_15, HAL_GPIO_DIRECTION_OUTPUT);
    if (HAL_GPIO_STATUS_OK != ret) {
        /*printf("hal_gpio_set_direction failed\r\n");*/
        hal_gpio_deinit(HAL_GPIO_15);
        return;
...
/*******************GPIO16	Flash_CLK	SPI Flash x2接口***********************/
    ret = hal_gpio_init(HAL_GPIO_16);
    if (HAL_GPIO_STATUS_OK != ret) {
        /*printf("GPIO init failed\r\n");*/
        hal_gpio_deinit(HAL_GPIO_16);
        return;
    }

    /* Set pin as GPIO mode.*/
    ret_pinmux_status = hal_pinmux_set_function(HAL_GPIO_16, HAL_GPIO_16_GPIO16);
    if (HAL_PINMUX_STATUS_OK != ret_pinmux_status) {
       /* printf("hal_pinmux_set_function  failed\r\n");*/
        hal_gpio_deinit(HAL_GPIO_16);
        return;
    ...
    /* Set GPIO as output.*/
    ret = hal_gpio_set_direction(HAL_GPIO_16, HAL_GPIO_DIRECTION_OUTPUT);
    if (HAL_GPIO_STATUS_OK != ret) {
        /*printf("hal_gpio_set_direction failed\r\n");*/
        hal_gpio_deinit(HAL_GPIO_16);
        return;
    ...
    /* Read the output data of the pin for further validation.*//*wangzaizhong */
    data_pull_up =HAL_GPIO_DATA_HIGH;
    ret = hal_gpio_set_output(HAL_GPIO_16, data_pull_up);
    if (HAL_GPIO_STATUS_OK != ret) {
        /*printf("hal_gpio_set_input failed\r\n");*/
        hal_gpio_deinit(HAL_GPIO_16);
        return;
...
/*******************GPIO17	Flash_CS	SPI     Flash x2接口***********************/
    ...
    /* Set GPIO as output.*/
    ret = hal_gpio_set_direction(HAL_GPIO_17, HAL_GPIO_DIRECTION_OUTPUT);
    if (HAL_GPIO_STATUS_OK != ret) {
        /*printf("hal_gpio_set_direction failed\r\n");*/
        hal_gpio_deinit(HAL_GPIO_17);
        return;
    ...
    /* Read the output data of the pin for further validation.*//*wangzaizhong */
    data_pull_up =HAL_GPIO_DATA_HIGH;
    ret = hal_gpio_set_output(HAL_GPIO_17, data_pull_up);
    if (HAL_GPIO_STATUS_OK != ret) {
        /*printf("hal_gpio_set_input failed\r\n");*/
        hal_gpio_deinit(HAL_GPIO_17);
        return;
...
void system_init(void)
{
	...
	/*wangzaizhong add  G113i GPIO init*/
	rc_g113i_gpio_init();

	LOG_I(common, "src_g113i_gpio_init ok.\r\n");
