...
atci_status_t atci_cmd_hdlr_pmu(atci_parse_cmd_param_t *parse_cmd) {
    ...
    case ATCI_CMD_MODE_EXECUTION: // rec: AT+EPMUREG=<op>  the handler need to parse the parameters
        ...
        if (strncmp(parse_cmd->string_ptr, "AT+EPMUREG=0,", strlen("AT+EPMUREG=0,")) == 0) {
            ...
            printf("Index :%d : %d",input_addr,pmu_auxadc_get_channel_value(input_addr));
            /* ATCI will help append "OK" at the end of response buffer  */
            response.response_flag |= ATCI_RESPONSE_FLAG_APPEND_OK;
            response.response_len = strlen((const char *) response.response_buf);
            ...
            mid_pos = NULL;
            end_pos = NULL;
            printf("input_case:0x%x, input_value:0x%x\r\n", input_case, input_value);
            switch (input_case){
                case 0:
            ...
            mid_pos = NULL;
            end_pos = NULL;
            printf("input_domain:0x%x, input_value:0x%x\r\n", input_domain, input_value);
            switch (input_domain) {
            case 0: //VCORE
            ...
            input_addr = htoi(end_pos);
                ...
                switch(input_addr) {
                    case 0:
                    printf("===Interrupt setting===\r\n");
                    printf("PMU INT MASK : COM0 :%x\r\n",
                            pmu_get_register_value_mt6388(PMU_INT_MASK_CON0, 0xffff, 0));
                    printf("PMU INT MASK : COM1 :%x\r\n", pmu_get_register_value_mt6388(PMU_INT_MASK_CON1, 0xffff, 0));
                    printf("PMU INT MASK : COM2 :%x\r\n", pmu_get_register_value_mt6388(PMU_INT_MASK_CON2, 0xffff, 0));
                    printf("PMU INT MASK : COM3 :%x\r\n", pmu_get_register_value_mt6388(PMU_INT_MASK_CON3, 0xffff, 0));
                    printf("PMU INT status : COM0 :%x\r\n", pmu_get_register_value_mt6388(PMU_INT_STATUS0, 0xffff, 0));
                    printf("PMU INT status : COM1 :%x\r\n", pmu_get_register_value_mt6388(PMU_INT_STATUS1, 0xffff, 0));
                    printf("PMU INT status : COM2 :%x\r\n", pmu_get_register_value_mt6388(PMU_INT_STATUS2, 0xffff, 0));
                    printf("PMU INT status : COM3 :%x\r\n", pmu_get_register_value_mt6388(PMU_INT_STATUS3, 0xffff, 0));

                    printf("PMU INT enable : COM0 :%x\r\n", pmu_get_register_value_mt6388(PMU_INT_CON0, 0xffff, 0));
                    printf("PMU INT enable : COM1 :%x\r\n", pmu_get_register_value_mt6388(PMU_INT_CON1, 0xffff, 0));
                    printf("PMU INT enable : COM2 :%x\r\n", pmu_get_register_value_mt6388(PMU_INT_CON2, 0xffff, 0));
                    printf("PMU INT enable : COM3 :%x\r\n", pmu_get_register_value_mt6388(PMU_INT_CON3, 0xffff, 0));

                    printf("===VCORE Setting===\r\n");
                    printf("Normal : %x\r\n",pmu_get_register_value_mt6388(PMU_RG_BUCK_VCORE_VOSEL_ADDR, PMU_RG_BUCK_VCORE_VOSEL_MASK, PMU_RG_BUCK_VCORE_VOSEL_SHIFT));
                    printf("00:0.7V ; 01:0.9V\r\n");
                    printf("Sleep voltage : %x\r\n",pmu_get_register_value_mt6388(PMU_RG_VCORE_SLEEP_VOLTAGE_ADDR, PMU_RG_VCORE_SLEEP_VOLTAGE_MASK, PMU_RG_VCORE_SLEEP_VOLTAGE_SHIFT));
                    printf("Sleep vosel : %x\r\n",pmu_get_register_value_mt6388(PMU_RG_BUCK_VCORE_VOSEL_SLEEP_ADDR, PMU_RG_BUCK_VCORE_VOSEL_SLEEP_MASK, PMU_RG_BUCK_VCORE_VOSEL_SLEEP_SHIFT));
                    printf("===VAUD18 Setting===\r\n");
                    printf("Normal : %x\r\n",pmu_get_register_value_mt6388(PMU_RG_BUCK_VAUD18_VOSEL_ADDR, PMU_RG_BUCK_VAUD18_VOSEL_MASK, PMU_RG_BUCK_VAUD18_VOSEL_SHIFT));
                    printf("00: 0.8V ; 01: 0.9V ; 10: 0.85V\r\n");
                    printf("Sleep voltag : %x\r\n",pmu_get_register_value_mt6388(PMU_RG_VAUD18_SLEEP_VOLTAGE_ADDR, PMU_RG_VAUD18_SLEEP_VOLTAGE_MASK, PMU_RG_VAUD18_SLEEP_VOLTAGE_SHIFT));
                    printf("===PMU_BUCK_VIO18===\r\n");
                    printf("Normal : %x\r\n",pmu_get_register_value_mt6388(PMU_RG_BUCK_VIO18_VOSEL_ADDR, PMU_RG_BUCK_VIO18_VOSEL_MASK, PMU_RG_BUCK_VIO18_VOSEL_SHIFT));
                    printf("===PMU_BUCK_VRF===\r\n");
                    printf("Normal : %x\r\n",pmu_get_register_value_mt6388(PMU_RG_BUCK_VRF_VOSEL_ADDR, PMU_RG_BUCK_VRF_VOSEL_MASK, PMU_RG_BUCK_VRF_VOSEL_SHIFT));
                    printf("Sleep : %x\r\n",pmu_get_register_value_mt6388(PMU_RG_BUCK_VRF_VOSEL_SLEEP_ADDR, PMU_RG_BUCK_VRF_VOSEL_SLEEP_MASK, PMU_RG_BUCK_VRF_VOSEL_SLEEP_SHIFT));
