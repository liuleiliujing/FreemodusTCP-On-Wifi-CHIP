...
void enter_rtc_mode()
{
    //printf("LPHQA_enter_rtc_mode : RTC_32K_XTAL\r\n");

    #ifdef MTK_HAL_EXT_32K_ENABLE
    printf("enter_rtc_mode : RTC_32K_XTAL\r\n");
    #else
    printf("enter_rtc_mode : RTC_32KLess\r\n");
    #endif
    ...
    if (back_from_rtc_mode == false) {
        ...
        printf("rtc mode wakeup by alarm test pass\r\n");
        rtc_alarm_setting();
...
void dump_clock_cg(void)
{
    ...
    for(i = 1;i < 28;i++){
        if(((PDN_COND0_status >> i)&0x01) == 0){
            //printf("PDN_COND0[%d]\r\n",i);
            switch(i){
                case 1 : printf("RG_SW_SPISLV_CG Clock on:%d\r\n",i);break;
                case 2 : printf("RG_SW_SDIOMST_CG Clock on:%d\r\n",i);break;
                case 3 : printf("RG_SW_SDIOMST_BUS_CG Clock on:%d\r\n",i);break;
                case 4 : printf("RG_SW_I2S0_CG Clock on:%d\r\n",i);break;
                case 5 : printf("RG_SW_I2S1_CG Clock on:%d\r\n",i);break;
                case 6 : printf("RG_SW_I2S2_CG Clock on:%d\r\n",i);break;
                case 7 : printf("RG_SW_I2S3_CG Clock on:%d\r\n",i);break;
                case 8 : printf("RG_SW_SPIMST0_CG Clock on:%d\r\n",i);break;
                case 9 : printf("RG_SW_SPIMST1_CG Clock on:%d\r\n",i);break;
                case 10 : printf("RG_SW_SPIMST2_CG Clock on:%d\r\n",i);break;
                case 11 : printf("RG_SW_UART1_CG Clock on:%d\r\n",i);break;
                case 12 : printf("RG_SW_UART2_CG Clock on:%d\r\n",i);break;
                case 13 : printf("RG_SW_BSI_CG Clock on:%d\r\n",i);break;
                case 14 : printf("RG_SW_IRRX_26M_CG Clock on:%d\r\n",i);break;

                case 16 : printf("RG_SW_CM_SYSROM_CG Clock on:%d\r\n",i);break;
                case 17 : printf("RG_SFC_SW_CG Clock on:%d\r\n",i);break;
                case 18 : printf("RG_SW_TRNG_CG Clock on:%d\r\n",i);break;
                case 19 : printf("RG_EMI_SW_CG Clock on:%d\r\n",i);break;
                case 20 : printf("RG_SW_UART0_CG Clock on:%d\r\n",i);break;
                case 21 : printf("RG_SW_CRYPTO_CG Clock on:%d\r\n",i);break;
                case 23 : printf("RG_SW_GPTIMER_CG Clock on:%d\r\n",i);break;
                case 24 : printf("RG_SW_OSTIMER_CG Clock on:%d\r\n",i);break;
                case 25 : printf("RG_SW_USB_CG Clock on:%d\r\n",i);break;
                case 26 : printf("RG_SW_USB_BUS_CG Clock on:%d\r\n",i);break;
                case 27 : printf("RG_SW_USB_DMA_CG Clock on:%d\r\n",i);break;
            }
        }
    }
    ...
    for(i = 0;i < 13;i++){
        if(((PDN_COND1_status >> i)&0x01) == 0){
          //  printf("PDN_COND1[%d]\r\n",i);
            switch(i){
                case 0 : printf("RG_SW_PWM0_CG Clock on:%d\r\n",i);break;
                case 1 : printf("RG_SW_PWM1_CG Clock on:%d\r\n",i);break;
                case 2 : printf("RG_SW_PWM2_CG Clock on:%d\r\n",i);break;
                case 3 : printf("RG_SW_PWM3_CG Clock on:%d\r\n",i);break;
                case 4 : printf("RG_SW_PWM4_CG Clock on:%d\r\n",i);break;
                case 5 : printf("RG_SW_PWM5_CG Clock on:%d\r\n",i);break;
                case 6 : printf("RG_SW_PWM6_CG Clock on:%d\r\n",i);break;
                case 7 : printf("RG_SW_PWM7_CG Clock on:%d\r\n",i);break;
                case 8 : printf("RG_SW_PWM8_CG Clock on:%d\r\n",i);break;
                case 9 : printf("RG_SW_PWM9_CG Clock on:%d\r\n",i);break;
                case 10 : printf("RG_SW_CM4_DMA_CG Clock on:%d\r\n",i);break;
                case 11 : printf("RG_SW_DSP_DMA_CG Clock on:%d\r\n",i);break;
                case 12 : printf("RG_SW_I2S_DMA_CG Clock on:%d\r\n",i);break;
            }
        }
    }
    ...
    for(i = 0;i < 27;i++){
        if(((XO_PDN_COND0_status >> i)&0x01) == 0){
           // printf("XO_PDN_COND0[%d]\r\n",i);
            switch(i){
                case 0 : printf("RG_SW_I2C_DMA_CG Clock on:%d\r\n",i);break;
                case 1 : printf("RG_SW_CAP_TOUCH_CG Clock on:%d\r\n",i);break;
                case 2 : printf("RG_SW_AUD_ENGINE_CG Clock on:%d\r\n",i);break;
                case 3 : printf("RG_SW_AUD_UL_HIRES_CG Clock on:%d\r\n",i);break;
                case 4 : printf("RG_SW_AUD_DL_HIRES_CG Clock on:%d\r\n",i);break;
                case 5 : printf("RG_SW_AUD_INTERFACE0_CG Clock on:%d\r\n",i);break;
                case 6 : printf("RG_SW_AUD_INTERFACE1_CG Clock on:%d\r\n",i);break;
                case 7 : printf("RG_SW_AUD_GPSRC_CG Clock on:%d\r\n",i);break;
                case 8 : printf("RG_SW_AUD_BUS_CG Clock on:%d\r\n",i);break;
                case 9 : printf("RG_SW_BT_26M_CG Clock on:%d\r\n",i);break;
                case 10 : printf("RG_SW_IRRX_BCLK_CG Clock on:%d\r\n",i);break;
                case 11 : printf("RG_SW_I2C0_CG Clock on:%d\r\n",i);break;
                case 12 : printf("RG_SW_I2C1_CG Clock on:%d\r\n",i);break;
                case 13 : printf("RG_SW_I2C2_CG Clock on:%d\r\n",i);break;
                case 14 : printf("RG_SW_ANC_CG Clock on:%d\r\n",i);break;
                case 15 : printf("RG_SW_BT_104M_CG Clock on:%d\r\n",i);break;
                case 16 : printf("RG_SW_SPM_CG Clock on:%d\r\n",i);break;
                case 17 : printf("RG_SW_MIXEDSYS_D_CG Clock on:%d\r\n",i);break;
                case 18 : printf("RG_SW_EFUSE_CG Clock on:%d\r\n",i);break;
                case 19 : printf("RG_SW_SEJ_CG Clock on:%d\r\n",i);break;
                case 20 : printf("RG_SW_I2C_AO_CG Clock on:%d\r\n",i);break;
                case 21 : printf("RG_SW_AUXADC_CG Clock on:%d\r\n",i);break;
                case 22 : printf("RG_SW_ABB_26M_CG Clock on:%d\r\n",i);break;
                case 23 : printf("RG_SW_OSC_1P1_CG Clock on:%d\r\n",i);break;
                case 24 : printf("RG_SW_OSC_0P9_CG Clock on:%d\r\n",i);break;
                case 25 : printf("RG_SW_GPLL_26M_CG Clock on:%d\r\n",i);break;
                case 26 : printf("RG_SW_APLL_26M_CG Clock on:%d\r\n",i);break;
            }
        }
    }

    printf("0xA2030B00:0x%x\r\n",*((volatile uint32_t*)(0xA2030B00)));
    printf("0xA2270300:0x%x\r\n",*((volatile uint32_t*)(0xA2270300)));
    printf("0xA2270330:0x%x\r\n",*((volatile uint32_t*)(0xA2270330)));
}
...
void lowpower_setting_check(void)
{
    ...
    printf("clock_pll_state[0]:%d\r\n",clock_get_pll_state(0));
    printf("clock_pll_state[1]:%d\r\n",clock_get_pll_state(1));
    printf("clock_pll_state[2]:%d\r\n",clock_get_pll_state(2));
    if(pll_result != 0){
        printf("===========PLL Low Power Check : Fail===========\r\n");
    }

    log_hal_info("AUDENC_ANA_CON0 =0x%x\r\n",  *AUDENC_ANA_CON0);
    log_hal_info("AUDENC_ANA_CON1 =0x%x\r\n",  *AUDENC_ANA_CON1);
    log_hal_info("AUDENC_ANA_CON2 =0x%x\r\n",  *AUDENC_ANA_CON2);
    log_hal_info("AUDENC_ANA_CON3 =0x%x\r\n",  *AUDENC_ANA_CON3);
    log_hal_info("AUDENC_ANA_CON4 =0x%x\r\n",  *AUDENC_ANA_CON4);
    log_hal_info("AUDENC_ANA_CON5 =0x%x\r\n",  *AUDENC_ANA_CON5);
    log_hal_info("AUDENC_ANA_CON6 =0x%x\r\n",  *AUDENC_ANA_CON6);
    log_hal_info("AUDENC_ANA_CON7 =0x%x\r\n",  *AUDENC_ANA_CON7);
    log_hal_info("AUDENC_ANA_CON8 =0x%x\r\n",  *AUDENC_ANA_CON8);
    log_hal_info("AUDENC_ANA_CON9 =0x%x\r\n",  *AUDENC_ANA_CON9);
    log_hal_info("AUDENC_ANA_CON10 =0x%x\r\n", *AUDENC_ANA_CON10);
    log_hal_info("AUDENC_ANA_CON11 =0x%x\r\n", *AUDENC_ANA_CON11);
    log_hal_info("AUDENC_ANA_CON12 =0x%x\r\n", *AUDENC_ANA_CON12);
    log_hal_info("AUDENC_ANA_CON13 =0x%x\r\n", *AUDENC_ANA_CON13);
    log_hal_info("AUDENC_ANA_CON14 =0x%x\r\n", *AUDENC_ANA_CON14);

    log_hal_info("AUDDEC_ANA_CON0 =0x%x\r\n",  *AUDDEC_ANA_CON0);
    log_hal_info("AUDDEC_ANA_CON1 =0x%x\r\n",  *AUDDEC_ANA_CON1);
    log_hal_info("AUDDEC_ANA_CON2 =0x%x\r\n",  *AUDDEC_ANA_CON2);
    log_hal_info("AUDDEC_ANA_CON3 =0x%x\r\n",  *AUDDEC_ANA_CON3);
    log_hal_info("AUDDEC_ANA_CON4 =0x%x\r\n",  *AUDDEC_ANA_CON4);
    log_hal_info("AUDDEC_ANA_CON5 =0x%x\r\n",  *AUDDEC_ANA_CON5);
    log_hal_info("AUDDEC_ANA_CON6 =0x%x\r\n",  *AUDDEC_ANA_CON6);
    log_hal_info("AUDDEC_ANA_CON7 =0x%x\r\n",  *AUDDEC_ANA_CON7);
    log_hal_info("AUDDEC_ANA_CON8 =0x%x\r\n",  *AUDDEC_ANA_CON8);
    log_hal_info("AUDDEC_ANA_CON9 =0x%x\r\n",  *AUDDEC_ANA_CON9);
    log_hal_info("AUDDEC_ANA_CON10 =0x%x\r\n", *AUDDEC_ANA_CON10);
    log_hal_info("AUDDEC_ANA_CON11 =0x%x\r\n", *AUDDEC_ANA_CON11);
    log_hal_info("AUDDEC_ANA_CON12 =0x%x\r\n", *AUDDEC_ANA_CON12);
    log_hal_info("AUDDEC_ANA_CON13 =0x%x\r\n", *AUDDEC_ANA_CON13);
    log_hal_info("AUDDEC_ANA_CON14 =0x%x\r\n", *AUDDEC_ANA_CON14);

    log_hal_info("AUDIO_TOP_CON0 =0x%x\r\n",   *AUDIO_TOP_CON0);

    log_hal_info("PMU2_ANA_CON0 =0x%x\r\n",    *PMU2_ANA_CON0);
    log_hal_info("PMU2_ANA_RO =0x%x\r\n",      *PMU2_ANA_RO);

    printf("dump clock cg setting\r\n");
    dump_clock_cg();

    if(pll_result == 0){
        printf("====================================================\r\n");
        printf("===========Low Power Setting Check : Pass===========\r\n");
        printf("====================================================\r\n");
    }
    else{
        printf("====================================================\r\n");
        printf("===========Low Power Setting Check : Fail===========\r\n");
        printf("====================================================\r\n");
    }
}
...
atci_status_t atci_cmd_hdlr_sleep_manager(atci_parse_cmd_param_t *parse_cmd)
{
    ...
    if (strstr((char *)parse_cmd->string_ptr, "AT+SM=0") != NULL) {
        strcpy((char *)response.response_buf, "AB155X Low Power Test Command Pass!!\r\n");
        response.response_len = strlen((char *) response.response_buf);
        response.response_flag |= ATCI_RESPONSE_FLAG_APPEND_OK;
        atci_send_response(&response);
...
/*
            printf("===============================================\r\n");
            printf("============adj normal vcore to 0.85V===========\r\n");
            printf("===============================================\r\n");
...
*/
        ...
        if (strstr((char *) parse_cmd->string_ptr, "AT+SM=LOCK,0,SLP") != NULL) {
            ...
            hal_sleep_manager_unlock_sleep(sleep_manager_handle);
            response.response_flag |= ATCI_RESPONSE_FLAG_APPEND_OK;
            strcpy((char *)response.response_buf, "unlock sleep manager handle\r\n");
        }
        if (strstr((char *) parse_cmd->string_ptr, "AT+SM=LOCK,1,SLP") != NULL) {
            hal_sleep_manager_lock_sleep(sleep_manager_handle);
            response.response_flag |= ATCI_RESPONSE_FLAG_APPEND_OK;
            strcpy((char *)response.response_buf, "lock sleep manager handle\r\n");
        }
        response.response_len = strlen((char *) response.response_buf);
        atci_send_response(&response);
      ...
      if (strstr((char *) parse_cmd->string_ptr, "AT+SM=PWR,ALL,0") != NULL){
        ...
        if (strstr((char *) parse_cmd->string_ptr, "AT+SM=PWR,ALL,1") != NULL){
            strcpy((char *)response.response_buf, "DSP0/DSP1/CONN/AUDIO MTCMOS On\r\n");
            spm_control_mtcmos(SPM_MTCMOS_DSP0, SPM_MTCMOS_PWR_ENABLE);
            spm_control_mtcmos(SPM_MTCMOS_DSP1, SPM_MTCMOS_PWR_ENABLE);
            spm_control_mtcmos(SPM_MTCMOS_AUDIO, SPM_MTCMOS_PWR_ENABLE);
            spm_control_mtcmos(SPM_MTCMOS_CONN, SPM_MTCMOS_PWR_ENABLE);
        ...
        if (strstr((char *) parse_cmd->string_ptr, "AT+SM=RTC,0") != NULL){
           // enter_rtc_off_mode();
            ...
            //RTC OFF Mode
            rtc_32k_off();
            printf("LPHQA_enter_rtc_mode : RTC OFF Mode\r\n");
            hal_gpt_delay_ms(2000);
            hal_rtc_enter_rtc_mode();
        }
        if (strstr((char *) parse_cmd->string_ptr, "AT+SM=RTC,1") != NULL){
            ...
            */
            ...
            printf("LPHQA_enter_rtc_mode : RTC_32K_XTAL\r\n");
            #else
            printf("LPHQA_enter_rtc_mode : RTC_32KLess\r\n");
            #endif
            hal_gpt_delay_ms(200);
            rtc_alarm_irq_test();
        }
        ...
        if (strstr((char *) parse_cmd->string_ptr, "AT+SM=AMIC,0") != NULL) {
            *((volatile uint32_t*)(0xA2120B04)) &= 0xFFFFFFE7;
            response.response_flag |= ATCI_RESPONSE_FLAG_APPEND_OK;
        }
        ...
        printf("force lock sleep handle : %d\r\n", (int)handle_index);
