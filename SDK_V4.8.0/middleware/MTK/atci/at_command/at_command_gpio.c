    ...
    switch (parse_cmd->mode) {
        ...
        case ATCI_CMD_MODE_EXECUTION:
            ...
            /* Set serveral configurations to one GPIO. */
                ...
                strncpy((char *)temp1, (char *)current_state[temp], strlen((char *)current_state[temp]));               //get current state string
                strncpy((char *)temp2, (char *)(pull_state[gpio_state.pull_type]), strlen((char *)(pull_state[gpio_state.pull_type]))); //get pull state string
