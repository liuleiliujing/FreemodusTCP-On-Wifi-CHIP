...
static void audio_turn_on_dmic_gpio(void)
{
    *(volatile uint32_t*)0xA20B0074 = 0x44622001;
    *(volatile uint32_t*)0x70000F48 = 0x00000000;
    *(volatile uint32_t*)0x70000F4C = 0x00000000;
}

static void audio_turn_on_ul_src(void)
{
    *(volatile uint32_t*)0x70000000 = 0x20004000;   //AUDIO_TOP_CON0
    *(volatile uint32_t*)0x70000010 = 0x00000001;   //AFE_DAC_CON0
    *(volatile uint32_t*)0x70000124 = 0x40404001;   //AFE_ADDA_UL_DL_CON0
    //*(volatile uint32_t*)0x70000114 = 0x1F060003;   //AFE_ADDA_UL_SRC_CON0
    *(volatile uint32_t*)0x70000114 = 0x00060003;   //AFE_ADDA_UL_SRC_CON0
    //*(volatile uint32_t*)0x70000118 = 0x08E18E18;   //AFE_ADDA_UL_SRC_CON0
}

static void audio_turn_on_ul(void)
{
    *(volatile uint32_t*)0xA2070224 = 0x00003020; //AUDDEC_ANA_CON9
    *(volatile uint32_t*)0xA2070224 = 0x00003021; //AUDDEC_ANA_CON9
    *(volatile uint32_t*)0xA207010C = 0x00000010; //AUDENC_ANA_CON3
    *(volatile uint32_t*)0xA2070224 = 0x00003021; //AUDDEC_ANA_CON9
    *(volatile uint32_t*)0xA2070108 = 0x00000002; //AUDENC_ANA_CON2
    *(volatile uint32_t*)0xA2070124 = 0x00000001; //AUDENC_ANA_CON9
    *(volatile uint32_t*)0xA2070124 = 0x00000001; //AUDENC_ANA_CON9
    *(volatile uint32_t*)0xA2070124 = 0x00000005; //AUDENC_ANA_CON9
    *(volatile uint32_t*)0xA2070124 = 0x00000005; //AUDENC_ANA_CON9
    *(volatile uint32_t*)0xA2070124 = 0x00000005; //AUDENC_ANA_CON9
    *(volatile uint32_t*)0xA2070130 = 0x00000019; //AUDENC_ANA_CON12
    *(volatile uint32_t*)0xA2070130 = 0x00000019; //AUDENC_ANA_CON12
    *(volatile uint32_t*)0xA2070130 = 0x00001019; //AUDENC_ANA_CON12
    *(volatile uint32_t*)0xA2070134 = 0x00000001; //AUDENC_ANA_CON13
    *(volatile uint32_t*)0xA2070134 = 0x00000001; //AUDENC_ANA_CON13
    *(volatile uint32_t*)0xA2070134 = 0x00001001; //AUDENC_ANA_CON13
    *(volatile uint32_t*)0xA2070104 = 0x00000004; //AUDENC_ANA_CON1
    *(volatile uint32_t*)0xA2070100 = 0x00000004; //AUDENC_ANA_CON0
    *(volatile uint32_t*)0xA2070100 = 0x00000045; //AUDENC_ANA_CON0
    *(volatile uint32_t*)0xA2070104 = 0x00000085; //AUDENC_ANA_CON1
    *(volatile uint32_t*)0xA2070100 = 0x00000345; //AUDENC_ANA_CON0
    *(volatile uint32_t*)0xA2070104 = 0x00000385; //AUDENC_ANA_CON1
    *(volatile uint32_t*)0xA2070104 = 0x00000387; //AUDENC_ANA_CON1
    *(volatile uint32_t*)0xA2070100 = 0x00000347; //AUDENC_ANA_CON0
    *(volatile uint32_t*)0x70000F98 = 0x00081A10; //AFE_DCCLK_CFG
    *(volatile uint32_t*)0x70000F98 = 0x00081810; //AFE_DCCLK_CFG
    *(volatile uint32_t*)0x70000F98 = 0x00081910; //AFE_DCCLK_CFG
    *(volatile uint32_t*)0xA207010C = 0x00000010; //AUDENC_ANA_CON3
    *(volatile uint32_t*)0xA207010C = 0x00000010; //AUDENC_ANA_CON3
    *(volatile uint32_t*)0xA2070100 = 0x00005347; //AUDENC_ANA_CON0
    *(volatile uint32_t*)0xA2070104 = 0x00005387; //AUDENC_ANA_CON1
    *(volatile uint32_t*)0xA207011C = 0x00000000; //AUDENC_ANA_CON7
    *(volatile uint32_t*)0xA2070108 = 0x00000002; //AUDENC_ANA_CON2
    *(volatile uint32_t*)0xA2070104 = 0x00005383; //AUDENC_ANA_CON1
    *(volatile uint32_t*)0xA2070100 = 0x00005343; //AUDENC_ANA_CON0
}
...
void hal_audio_switch_mic_driver(mic_drv drv){
    mic_drv curr = *((volatile uint32_t*)(0xA2120B04)) >>3 & 0x01 ;
    if (drv ^ curr) {
        *((volatile uint32_t*)(0xA2120B04)) &= 0xFFFFFFF7;
        if(drv){
...
bool audio_stream_in(bool enable,smt_ch chennel,fft_buf_t *fft_bufs){
    audio_smt_test(enable,chennel);
    if(enable){
...
void hal_audio_init_stream_buf(fft_buf_t *fft_bufs){
    ...
    bzero(fft_bufs->cpyIdx,FFT_BUFFER_SIZE << 1);
}
...
void audio_smt_test(bool enable,smt_ch chennel)
{
    if (enable) {
          uint32_t interconnection = 0;
          audio_smt_flag = true;
