...
typedef enum
{
    FOTA_MULTI_INFO_TYPE_NONE,

    FOTA_MULTI_INFO_TYPE_STATE,
    FOTA_MULTI_INFO_TYPE_UPGRADE_FLAG,
    FOTA_MULTI_INFO_TYPE_DL_INTEGRITY_RES,
    FOTA_MULTI_INFO_TYPE_VERSION,

    /* Add new info type before this line. */
    FOTA_MULTI_INFO_TYPE_NULL,
    FOTA_MULTI_INFO_TYPE_MAX
