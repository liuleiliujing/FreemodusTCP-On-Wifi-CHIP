 ...
 *    @code
 *       bt_aws_mce_set_state(&handle, BT_AWS_MCE_STATE_CONNECTABLE_AGENT);
 *    @endcode
 ...
 */
#define BT_AWS_MCE_STATE_NONE               0x00          /**< No State. */
#define BT_AWS_MCE_STATE_INACTIVE_AGENT     0x40          /**< Inactive Agent State. */
#define BT_AWS_MCE_STATE_CONNECTABLE_AGENT  0x50          /**< Connectable Agent State. */
#define BT_AWS_MCE_STATE_ATTACHED_AGENT     0x60          /**< Attached Agent State */
typedef uint8_t bt_aws_mce_state_type_t;                  /**< The type of AWS-MCE Agent state. */
...
typedef struct {
    ...
    uint16_t data_length;                       /**< The packet data length for information updated */
...
typedef struct {
    uint32_t handle;                  /**< AWS-MCE handle. */
    bt_aws_mce_state_type_t state;    /**< AWS-MCE Agent new state. */
 ...
 */
bt_status_t bt_aws_mce_set_state(uint32_t handle, bt_aws_mce_state_type_t state);
 ...
 *                      #BT_STATUS_OUT_OF_MEMORY, the operation failed because there is not enough memory.
 */
bt_status_t bt_aws_mce_update_information(uint32_t handle, const bt_aws_mce_information_t *information, bool urgent);
 ...
 *                      Note: The data length must be less than 100B.
 * @param[in] handle    is the connection handle for the specified link.
