...
typedef struct {
    ...
    uint8_t    tx_power_level_offset;    /**< Initial/fixed level offset below the bt/le connection radio transmission power. The range is between 0 and 3. The larger the value, the weaker the TX power. */
    ...
    uint8_t    bt_max_tx_power_level;    /**< Maximum level of bt connection radio transmission power. The range is between 0 and 7. The larger the value, the stronger the TX power. Only available in AB155X.*/
